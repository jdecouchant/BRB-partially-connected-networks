#ifndef BRACHA_CPA_HANDLER_H
#define BRACHA_CPA_HANDLER_H

#include "Handler.h"

class BrachaCPAHandler: public Handler {
...
public:    
    BrachaCPAHandler(PID id, PeerNet::Config pconf, Nodes nodes, std::string topofilename, bool mod1, bool mod2, bool mod3, bool mod4, bool mod5);
